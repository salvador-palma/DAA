# These are a few helper functions for the first lecture notebook to test the different algorithms for multiplication.
...
# next, you can plt.plot(nValues, tValues)
# or use other modules from matplotlib (or seaborn)
